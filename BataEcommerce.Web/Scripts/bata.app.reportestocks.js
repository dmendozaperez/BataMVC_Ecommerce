...
// =======================================================================//
var txtProCod, txtProNom, selCat, txtTalla, ddbSigno, btnSigno, hddSigno, txtStock, btnConsultar, btnLimpiar, ifrReporte, frmConsulta, lblBtnSigno;
...
function MostrarReporte(e) {
    ...
    $.ajax({
        url: GLB_RUT_APP_REPSTOR + "?pProcod=" + pProCod + "&pPronom=" + pProNom + "&pCateg=" + pCateg + "&pTalla=" + pTalla + "&pSigno=" + pSigno + "&pStock=" + pStock,
        cache: false,
        async: false,
        dataType: "html",
        success: function (data) {
...
function Limpiar(e) {
    ...
    Bata.FncLlenarControl(txtStock, '');
